...
class Updaters(Scene):
    def construct(self):
        num = MathTex("ln(2)")
        box = always_redraw( lambda: SurroundingRectangle(num, color=BLUE_A, fill_opacity=0.4, fill_color=RED, buff=0.3))
        name = always_redraw( lambda: Tex("Sumaiiaa").next_to(box, DOWN, buff=0.25))
